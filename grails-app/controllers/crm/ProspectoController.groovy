...
class ProspectoController extends BaseController{
    ...
    def descalificarDef(){
        ...
        if (params.prospectos!=null){         
            ...
            if (sw==0)
            flash.message=message(code:'descalificar.exito.label',default:'DescalificaciÛn ha sido exitosa') //"Descalificaci√≥n ha sido exitosa "
            else 
    ...
    def calificar(){
        ...
        if (params.prospectos!=null){  
            ...
            if (sw==0)
            flash.message=message(code:'calificar.exito.label',default:'CalificaciÛn ha sido exitosa')//"Calificaci√≥n ha sido exitosa "
            else 
    ...
    def exportar(){
        ...
        if (!params.id  in ['excel','json','xml']) {
            flash.warning="Format de exportaci√≥n no permitido.Verifique"
            return
        }
