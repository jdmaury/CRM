...
<html>
    ...
    <body>
        <div id="edit-vencimiento" class="content scaffold-edit" role="main">
            ...
            <g:form class="form-horizontal" url="[resource:contratoInstance, action:'renovarContratoDef']" enctype="multipart/form-data" method="PUT" >
