<div class="pull-left">
	...
	<a class="btn btn-mini btn-success" href="/crm/empleado/edit/${empleadoInstance.id}" >
   ...
   <a href="#" class="btn btn-danger btn-mini" 
      ...
      function(result) { if(result)window.location.href="${createLink(url:[controller:'Empleado', action:'borrar',id:empleadoInstance.id])}"})'>                                                     
