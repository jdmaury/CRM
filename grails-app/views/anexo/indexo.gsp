...
<html>
    <head>
        <%--todo revisar la entidad que se toma y como guardar el anexo para la oportunidad ya que las entidaddes se repiten con las de los pedidos  --%>
    ...
    <body>
        ...
        <div id="detalleconten">
            ...
            <div class="row-fluid sortable"> 
                ...
                //Long  xidoportunidad
                long idoportundad
                if (xentidad=='oportunidad') idoportundad=xidentidad.toLong()//idoportundad=xidentidad.toLong()
                else idoportundad=0
                %>
             
                    <div class="pull-left">
                        <div class="pull-left">
                            <g:if test="${'CREAR' in seguridadService.operacionesPorOpcion(session['idUsuario'],'/anexo/indexo')}">
