<div id="${fp.containerId}"
     ...
     style="${fp.containerVisibleStyle}${fp.containerStyle}; margin-top: -40px !Important; ">
    ...
    <script>
      function validarFiltro(xcampo){ 
       debugger;
        var campo=document.getElementById(xcampo);
        console.log(campo.type);
        if (campo.type="text")
          if (campo.value !='')
            document.getElementById("birdboton").disabled=''; 
           else
              document.getElementById("birdboton").disabled='disabled'; 
    }
</script>
</div> 
