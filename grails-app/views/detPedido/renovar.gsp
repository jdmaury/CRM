...
<html>
    ...
    <body>
        <div id="edit-vencimiento" class="content scaffold-edit" role="main">
            <h2>Renovación de PEDIDOVencimiento</h2>
            ...
            <g:form class="form-horizontal" url="[resource:detPedidoInstance, action:'renovarContratoDef']" enctype="multipart/form-data" method="PUT" >
