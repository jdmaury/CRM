...
<g:hiddenField id="id" name="id" value="${personaInstance?.id}"/> 
...
<div class="control-group  ${hasErrors(bean: personaInstance, field: 'primerNombre', 'error')} required ">
	...
	<div class="controls">
	   <g:textField name="primerNombre"  id="primerNombre" required="" maxlength="30" value="${personaInstance?.primerNombre}"    disabled="${xronly}" />
	</div>
</div>
...
<div class="control-group  ${hasErrors(bean: personaInstance, field: 'primerApellido', 'error')} required ">
	...
	<div class="controls">
	   <g:textField name="primerApellido" id="primerApellido" required="" maxlength="30" value="${personaInstance?.primerApellido}"  disabled="${xronly}" />
	</div>
</div>
...
<div class="control-group  ${hasErrors(bean: personaInstance, field: 'email', 'error')} ">
	...
	<div class="controls">
	  <g:textField type="email" name="email" id="email"  maxlength="100" value="${personaInstance?.email}" required="" />
	</div>
</div>
...
<div class="control-group  ${hasErrors(bean: personaInstance, field: 'celularPrincipal', 'error')} required ">
	...
	<div class="controls">
	   <g:textField name="celularPrincipal" id="celularPrincipal"  maxlength="15" value="${personaInstance?.celularPrincipal}"  disabled="${xronly}" />
	</div>
</div>
...
<div class="control-group  ${hasErrors(bean: personaInstance, field: 'telefonoFijo', 'error')} ">
	<label class="control-label" for="telefonoFijo">
      ...
      <div class="controls">
	<g:textField name="telefonoFijo" id="telefonoFijo" maxlength="15" value="${personaInstance?.telefonoFijo}" required=""  disabled="${xronly}"/>
    </div> 
</div>
