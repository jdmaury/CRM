    ...
    <body>
        ...
        <div id="boxVencimiento">	                
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="idTipoConvenio" title="${message(code: 'vencimiento.idTipoConvenio.label', default: 'Tipo Convenio')}"  params="${filterParams}" />
                    ...
                    <%def contador=0 %>
                      <g:each in="${vencimientoInstanceList}" status="i" var="vencimientoInstance">
							...
							<td>${generalService.getValorParametro(vencimientoInstance?.idTipoConvenio)}</td>
            ...
            <div class="pagination_crm">
                <g:paginate total="${vencimientoInstanceCount ?: 0}" domainBean="Vencimiento"  params="${[tipoVenc:tipoVenc,idenc:params.idenc,clicConSop:1]}"/>                    
            </div>            
        </div>
    </div>
<script>
