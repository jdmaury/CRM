...
<html>
    ...
    <body>
        <div id="edit-vencimiento" class="content scaffold-edit" role="main">
            <h2>Renovación de Vencimiento</h2>
            ...
            <g:form class="form-horizontal" url="[resource:vencimientoInstance, action:'renovarVencimientoDef']" enctype="multipart/form-data" method="PUT" >
