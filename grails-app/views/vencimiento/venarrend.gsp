    ...
    <body>
        ...
        <div id="boxVencimiento">	                
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="refTipModNumContract" title="${message(code: 'vencimiento.refTipModNumContract.label', default: 'Nro. Contrato')}"  params="${filterParams}" />
                    ...
                    <%def contador=0 %>
                      <g:each in="${vencimientoInstanceList}" status="i" var="vencimientoInstance">
                            ...
                            <td>${fieldValue(bean: vencimientoInstance, field: "refTipModNumContract")}</td>
            ...
            <div class="pagination_crm">
                <g:paginate total="${vencimientoInstanceCount ?: 0}" domainBean="Vencimiento"  params="${[tipoVenc:tipoVenc,idenc:params.idenc,clicVenArrend:1]}"/>                    
            </div>            
        </div>
    </div>
<script>
