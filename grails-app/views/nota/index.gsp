                        ...
                        <div class="pull-left">
                            <g:if test="${'CREAR' in seguridadService.operacionesPorOpcion(session['idUsuario'],'/nota/index')}">
                                ...
                                <a class="btn btn-mini btn-primary" href="/crm/nota/create/?ident=${xidentidad}&entidad=${xentidad}&tnota=${xtiponota}">
                                    ...
                                    <strong><g:message code="default.new.label" default="Nuevo"/></strong>
                                </a>
                        ...
                        <ul class="dropdown-menu">
                            <g:if test="${sw_crud[4]==1}">
                                ...
                                <g:if test="${'BORRAR' in session['operaciones']}">
                                 <%  swacc=1 %>
                                <li><a href="/crm/nota/listarBorrados/${xidentidad}?entidad=${xentidad}" ><g:message code="borrados.template.label" default="Ver Borrados"/></a></li>
                                </g:if>
                                <g:if test="${swacc==0}" >
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <g:sortableColumn class="span2" property="fecha" title="${message(code: 'nota.fechaCreacion.label', default: 'Fecha')}" />
                                
                                <g:sortableColumn class="span2" property="Autor" title="${message(code: 'nota.idAutor.label', default: 'Autor')}" />
                               
                                <g:sortableColumn class="span4" property="nota" title="${message(code: 'nota.comentarios.label', default: 'Comentario')}" />

                              <%--  <g:sortableColumn property="idTipoNota" title="${message(code: 'nota.idTipoNota.label', default: 'Tipo')}" />--%>
