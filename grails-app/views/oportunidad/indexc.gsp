...
<body >
    ...
    <div id="detalleconten">           
        ...
        <!--ADICIONAR EL ENCABEZADO DE LA INFORMACION DEL EMPLEADO TOTALES DE TIENE COMENTADO HASTA NO ESTAR OK -->
                       ...
                       <g:each in="${nodos}" status="i" var="nodo1">
                        <div class="box-content-tabla">
                            <dl>                              
                                ...
                                <a  id="${nodo1?.id}" data-url="${createLink(controller: 'oportunidad', action: 'traerNodo1', params:[orden:'nombreVendedor',campoFiltro1:'idSucursal', campoFiltro2:'',campoFiltro3:'', categoria:'empleado', idGuardar:'empleadoId', plantilla:'6', ultimoNodo:'No'])}" nodo="2" class="empresa" href="#${nodo1?.id}_container" data-toggle="collapse">
