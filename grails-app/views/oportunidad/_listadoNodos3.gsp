...
<dd>
            ...
            <g:each in="${nodo}" status="i" var="nodo2">
                <div class="box-content-tabla">
                    <dl>                        
                        <a  class="nodo3" id="${cId}-${nodo2?.id}" data-url="${createLink(controller: 'oportunidad', action: 'traerNodo1', params:[orden:'nombreCliente',campoFiltro1:'trimestre', campoFiltro2:'idSucursal',campoFiltro3:'nombreVendedor', categoria:'nombreCliente', idGuardar:'empresaId', plantilla:'4',ultimoNodo:'No'])}" nodo="4" href="#${cId}-${nodo2?.id}_container" data-toggle="collapse" >
