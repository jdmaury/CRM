                    ...
                    <g:each in="${nodos}" status="i" var="nodo1">
                        <div class="box-content-tabla">
                            <dl>                              
                                ...
                                <a  id="${nodo1?.id}" data-url="${createLink(controller: 'pedido', action: 'traerNodo', params:[orden:'idSucursal',campoFiltro1:'idEstadoPedido', campoFiltro2:'',campoFiltro3:'', categoria:'idSucursal', idGuardar:'idSucursal', plantilla:'EstCiuEmp2', ultimoNodo:'No'])}" nodo="2" class="empresa" href="#${nodo1?.id}_container" data-toggle="collapse">
