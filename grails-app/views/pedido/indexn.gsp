                   ...
                   <g:each in="${nodo}" status="i" var="pedido">
                        <div class="box-content-tabla">
                            <dl>                              
                                ...
                                <a  id="${pedido?.id}" data-url="${createLink(controller: 'pedido', action: 'buscarListadoRegistros', params:[mostrar:'pedidoXitem'] )}" nodo="1" class="empresa" href="#${pedido?.id}_container" data-toggle="collapse">
