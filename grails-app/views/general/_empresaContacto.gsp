...
<div class="controls">
    ...
    <div class="control-group">        
        ...
        placeholder="${message(code: 'contacto.placeholder.label')}" 
        />
        ...
        <g:if test="${zronly=='false'}">    
            <g:if test="${'MODIFICAR' in session['operaciones']}">
                <button type="button" class="btn  btn-mini" style="margin-left:8px"
           ...
           <g:if test="${'CREAR' in session['operaciones']}">
                ...
                <i class="icon-briefcase" ></i>&nbsp;<g:message code="default.new.label"/></button>
            </g:if>
        </g:if>
        <span id="msgNoExite" style="display:none;">
           <b style="color:red; padding-top:3px;"><g:message code="empresa.notfound.label"/></b>
        </span>
    </div>
</div>
    ...
    <div class="controls" > 
        ...
        <g:if test="${xronly=='false'}" >
         ...
         <g:if test="${'CREAR' in session['operaciones']}">
            ...
            <i class="icon-user" ></i>&nbsp;<g:message code="default.new.label"/></button>
            </g:if>
        </g:if>
        <span id="msgNoExite2" style="display:none;">
               <b style="color:red; padding-top:3px;"><g:message code="contacto.notfound.label"/></b>
        </span>
