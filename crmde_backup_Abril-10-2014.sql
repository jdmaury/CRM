...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`crmdev` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
DROP TABLE IF EXISTS `elementos_por_oportunidad`;
...
insert  into `elementos_por_oportunidad`(`id`,`cantidad`,`eliminado`,`id_estado_elemento_por_oportunidad`,`id_linea`,`id_posibilidad`,`id_sublinea`,`valor`,`id_marca`,`id_tipo_producto`,`id_oportunidad`) values (1,'3',0,'genactivo',2,17,3,'1,000,000','prodmarc01','prodtipo04',0),(2,'20',0,'genactivo',1,17,1,'12,600','prodmarc02','prodtipo02',0),(3,'10',0,'genactivo',2,17,3,'80','prodmarc01','prodtipo03',0),(4,'1',0,'genactivo',1,13,1,'5,000','prodmarc01','prodtipo02',0),(5,'1',0,'genactivo',1,3,1,'15,000','prodmarc01','prodtipo01',0),(6,'2',1,'genactivo',1,1,1,'1,000','prodmarc01','prodtipo01',0),(7,'1',0,'genactivo',1,1,1,'3,500','prodmarc01','prodtipo02',0),(8,'20',1,'genactivo',2,1,3,'8','prodmarc01','prodtipo03',0);
...
DROP TABLE IF EXISTS `enc_vencimientos`;
...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `pedidos_ibfk_1` FOREIGN KEY (`posibilidad_id`) REFERENCES `posibilidades` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

/*Data for the table `pedidos` */

insert  into `pedidos`(`id`,`arquitecto_sol`,`campania_redsis`,`cliente_nuevo`,`compra_ibm`,`desc_campania`,`desc_polizas`,`dir_despacho`,`dir_entrega_factura`,`eliminado`,`facturacion_parcial`,`fecha_entrega`,`fecha_apertura`,`id_bid_nexsys`,`id_contacto`,`id_estado_pedido`,`id_forma_pago`,`id_mondeda_factura`,`id_producto_disponible`,`id_tipo_precio`,`id_vendedor`,`lista_arquitectos`,`num_cliente`,`orden_compra`,`requiere_polizas`,`servicio_ibm`,`num_pedido`,`id_sucursal`,`posibilidad_id`,`empresa_id`,`id_usuario_autor`,`oportunidad_id`) values (1,'N','N','N','N',NULL,NULL,'xx','yy',0,'N','11/02/2014','27-01-2014','N',47,'pedestad01','pedfpago01','pedtmone01',NULL,'pedtprec01',4,',pedarqui01,pedarqui02',NULL,'OC-1520','N','N','BAQ-0001-14',1,5,20,NULL,NULL),(2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,'15-02-2014',NULL,50,'pedestad01',NULL,NULL,NULL,NULL,4,NULL,NULL,'1545',NULL,NULL,'BAQ-0002-14',1,NULL,11,NULL,NULL),(3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,'16-03-2014',NULL,48,'pedestad01',NULL,NULL,NULL,NULL,4,NULL,NULL,'1545',NULL,NULL,'BAQ-0003-14',1,3,14,NULL,NULL),(4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'19-03-2014','21-03-2014',NULL,53,'pedestad01',NULL,NULL,NULL,NULL,45,NULL,NULL,'1354',NULL,NULL,'BOG-0001-14',5,NULL,10,NULL,NULL),(5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'20-03-2014','31-03-2014',NULL,17,'pedestad01',NULL,NULL,NULL,NULL,45,NULL,NULL,'1568',NULL,NULL,'BOG-0002-14',5,NULL,8,NULL,NULL),(6,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'20-03-2014','31-03-2014',NULL,52,'pedestad01',NULL,NULL,NULL,NULL,45,NULL,NULL,'15645',NULL,NULL,'BAQ-0004-14',1,NULL,23,NULL,NULL);
...
CREATE TABLE `posibilidades` (
  ...
  CONSTRAINT `fk_posib_empresas` FOREIGN KEY (`empresa_id`) REFERENCES `empresas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1;

/*Data for the table `posibilidades` */

insert  into `posibilidades`(`id`,`id_tipo_posibilidad`,`empresa_id`,`id_etapa`,`nombre_posibilidad`,`desc_posibilidad`,`fecha_apertura`,`fecha_cierre_estimada`,`fecha_cierre_real`,`id_estado_posibilidad`,`eliminado`,`valor_posibilidad`,`id_contacto`,`id_vendedor`,`id_razon_cancelacion`,`otra_razon_cancelacion`,`id_actividad_mercadeo`,`id_condicion`,`nombre_actividad_mercadeo`,`num_oportunidad_fabricante`,`valor_facturado`,`num_oportunidad`,`observ_cambio_vendedor`,`observ_cierre`,`id_motivo_perdida`,`id_sucursal`) values (1,'posoportca',11,'posventa10','Servidor IBM','ok','20/02/2014','20/03/2014',NULL,'posenproce',0,'15000.00',50,4,NULL,NULL,NULL,'poscondi01',NULL,NULL,NULL,'BAQ-0002-14',NULL,NULL,NULL,0),(2,'posportunc',11,NULL,'Cableado con fibra','ok','20/02/2014','20/03/2014',NULL,'posoportun',0,'8000.00',47,45,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0),(3,'posoportca',14,'posventa10','Servidor AIX','Detalle del servidor xx','16/02/2014','28/03/2014',NULL,'posenproce',0,'15000.00',48,4,NULL,NULL,'posacmer01','poscondi01',NULL,'91535;450220',NULL,'BAQ-0001-14',NULL,NULL,NULL,0),(4,'posoportsc',23,NULL,'Router para telefonia ip E1','ok','25/02/2014',NULL,NULL,'posactivo',0,'3500.00',52,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0),(5,'posoportca',20,NULL,'Plataforma Alfresco',NULL,'25/02/2014','26/03/2014',NULL,'posenproce',0,'10000.00',50,4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BAQ-0004-14',NULL,NULL,NULL,0),(6,'posoportca',11,NULL,'Cableado  Bodega X',NULL,NULL,NULL,NULL,'posenproce',0,'5000.00',50,4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BAQ-0003-14',NULL,NULL,NULL,0),(7,'posoportsc',11,NULL,'15 Puintos de Ventas','okok',NULL,NULL,NULL,'posenproce',0,'30000.00',47,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0),(8,'posoportsc',21,NULL,'Horas de Capacitación Softmachine',NULL,'13-03-2014','30-03-2014',NULL,'posactivo',0,'7500.00',48,4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,6),(9,'posoportsc',8,NULL,'Implementacion Alfresco','Gestion Doc. Basica','14-03-2014','30-03-2014',NULL,'posenproce',0,'5000.00',49,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0),(10,'posoportsc',11,NULL,'Instalacion Processmaker','ok','15-03-2014','29-03-2014',NULL,'posenproce',1,'4500.00',46,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0),(11,'posoportsc',11,NULL,'Prueba xx','xx','04-03-2014','24-04-2014',NULL,'posenproce',0,'5500.00',44,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0);
...
CREATE TABLE `propuestas` (
  ...
  CONSTRAINT `FKE3639A0633685ACA` FOREIGN KEY (`posibilidad_id`) REFERENCES `posibilidades` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

/*Data for the table `propuestas` */

insert  into `propuestas`(`id`,`eliminado`,`fecha`,`id_contacto`,`id_estado_propuesta`,`id_vendedor`,`num_propuesta`,`posibilidad_id`,`valor`,`oportunidad_id`) values (1,0,'25/02/2014',44,'genactivo',45,'BAQ-0002-14',1,'50000',0),(3,0,'22-03-2014',48,'genactivo',4,'BAQ-0001-14',3,'11500',0),(5,0,'27-03-2014',48,'genactivo',4,'BAQ-0002-14',3,'8500',0);
...
DROP TABLE IF EXISTS `registro_oportunidades`;
...
CREATE TABLE `registro_oportunidades` (
  ...
  CONSTRAINT `FKBEE721E933685ACA` FOREIGN KEY (`posibilidad_id`) REFERENCES `posibilidades` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `registro_oportunidades` */

insert  into `registro_oportunidades`(`id`,`eliminado`,`fecha`,`id_asignadoa`,`id_autor`,`id_estado_registro_oportunidad`,`num_registro_oportunidad`,`posibilidad_id`,`id_registro_en`,`oportunidad_id`) values (1,0,'11-03-2014',45,43,'regenproc',NULL,3,'myrIBM',0);
...
insert  into `territorios`(`id`,`padre_id`,`codigo_territorio`,`id_tipo_territorio`,`nombre_territorio`,`estado_territorio`,`eliminado`) values (1,NULL,'CO','terpais','Colombia','A',0),(2,1,'N','terregion','Norte','A',0),(3,1,'C','terregion','Centro','A',0),(4,1,'Or','terregion','Oriente','A',0),(5,1,'S','terregion','Sur','A',0),(6,1,'Oc','terregion','Occidente','A',0),(7,NULL,'','terdpto','Amazonas','',0),(8,NULL,'','terdpto','Antioquia','',0),(9,NULL,'','terdpto','Arauca','',0),(10,NULL,'','terdpto','Atlántico','',0),(11,NULL,'','terdpto','Bolívar','',0),(12,NULL,'','terdpto','Boyacá','',0),(13,NULL,'','terdpto','Caldas','',0),(14,NULL,'','terdpto','Caquetá','',0),(15,NULL,'','terdpto','Casanare','',0),(16,NULL,'','terdpto','Cauca','',0),(17,NULL,'','terdpto','Cesar','',0),(18,NULL,'','terdpto','Chocó','',0),(19,NULL,'','terdpto','Córdoba','',0),(20,NULL,'','terdpto','Cundinamarca','',0),(21,NULL,'','terdpto','Guainía','',0),(22,NULL,'','terdpto','Guaviare','',0),(23,NULL,'','terdpto','Huila','',0),(24,NULL,'','terdpto','La guajira','',0),(25,NULL,'','terdpto','Magdalena','',0),(26,NULL,'','terdpto','Meta','',0),(27,NULL,'','terdpto','Nariño','',0),(28,NULL,'','terdpto','Norte de santander','',0),(29,NULL,'','terdpto','Putumayo','',0),(30,NULL,'','terdpto','Quindío','',0),(31,NULL,'','terdpto','Risaralda','',0),(32,NULL,'','terdpto','San andrés y rovidencia','',0),(33,NULL,'','terdpto','Santander','',0),(34,NULL,'','terdpto','Sucre','',0),(35,NULL,'','terdpto','Tolima','',0),(36,NULL,'','terdpto','Valle del cauca','',0),(37,NULL,'','terdpto','Vaupés','',0),(38,NULL,'','terdpto','Vichada','',0),(39,7,'','termunicip','El encanto','',0),(40,7,'','termunicip','La chorrera','',0),(41,7,'','termunicip','La pedrera','',0),(42,7,'','termunicip','La victoria','',0),(43,7,'','termunicip','Leticia','',0),(44,7,'','termunicip','Miriti','',0),(45,7,'','termunicip','Puerto alegria','',0),(46,7,'','termunicip','Puerto arica','',0),(47,7,'','termunicip','Puerto nariño','',0),(48,7,'','termunicip','Puerto santander','',0),(49,7,'','termunicip','Turapaca','',0),(50,8,'','termunicip','Abejorral','',0),(51,8,'','termunicip','Abriaqui','',0),(52,8,'','termunicip','Alejandria','',0),(53,8,'','termunicip','Amaga','',0),(54,8,'','termunicip','Amalfi','',0),(55,8,'','termunicip','Andes','',0),(56,8,'','termunicip','Angelopolis','',0),(57,8,'','termunicip','Angostura','',0),(58,8,'','termunicip','Anori','',0),(59,8,'','termunicip','Antioquia','',0),(60,8,'','termunicip','Anza','',0),(61,8,'','termunicip','Apartado','',0),(62,8,'','termunicip','Arboletes','',0),(63,8,'','termunicip','Argelia','',0),(64,8,'','termunicip','Armenia','',0),(65,8,'','termunicip','Barbosa','',0),(66,8,'','termunicip','Bello','',0),(67,8,'','termunicip','Belmira','',0),(68,8,'','termunicip','Betania','',0),(69,8,'','termunicip','Betulia','',0),(70,8,'','termunicip','Bolivar','',0),(71,8,'','termunicip','Briceño','',0),(72,8,'','termunicip','Buritica','',0),(73,8,'','termunicip','Caceres','',0),(74,8,'','termunicip','Caicedo','',0),(75,8,'','termunicip','Caldas','',0),(76,8,'','termunicip','Campamento','',0),(77,8,'','termunicip','Canasgordas','',0),(78,8,'','termunicip','Caracoli','',0),(79,8,'','termunicip','Caramanta','',0),(80,8,'','termunicip','Carepa','',0),(81,8,'','termunicip','Carmen de viboral','',0),(82,8,'','termunicip','Carolina del principe','',0),(83,8,'','termunicip','Caucasia','',0),(84,8,'','termunicip','Chigorodo','',0),(85,8,'','termunicip','Cisneros','',0),(86,8,'','termunicip','Cocorna','',0),(87,8,'','termunicip','Concepcion','',0),(88,8,'','termunicip','Concordia','',0),(89,8,'','termunicip','Copacabana','',0),(90,8,'','termunicip','Dabeiba','',0),(91,8,'','termunicip','Donmatias','',0),(92,8,'','termunicip','Ebejico','',0),(93,8,'','termunicip','El bagre','',0),(94,8,'','termunicip','El penol','',0),(95,8,'','termunicip','El retiro','',0),(96,8,'','termunicip','Entrerrios','',0),(97,8,'','termunicip','Envigado','',0),(98,8,'','termunicip','Fredonia','',0),(99,8,'','termunicip','Frontino','',0),(100,8,'','termunicip','Giraldo','',0),(101,8,'','termunicip','Girardota','',0),(102,8,'','termunicip','Gomez plata','',0),(103,8,'','termunicip','Granada','',0),(104,8,'','termunicip','Guadalupe','',0),(105,8,'','termunicip','Guarne','',0),(106,8,'','termunicip','Guataque','',0),(107,8,'','termunicip','Heliconia','',0),(108,8,'','termunicip','Hispania','',0),(109,8,'','termunicip','Itagui','',0),(110,8,'','termunicip','Ituango','',0),(111,8,'','termunicip','Jardin','',0),(112,8,'','termunicip','Jerico','',0),(113,8,'','termunicip','La ceja','',0),(114,8,'','termunicip','La estrella','',0),(115,8,'','termunicip','La pintada','',0),(116,8,'','termunicip','La union','',0),(117,8,'','termunicip','Liborina','',0),(118,8,'','termunicip','Maceo','',0),(119,8,'','termunicip','Marinilla','',0),(120,8,'','termunicip','Medellin','',0),(121,8,'','termunicip','Montebello','',0),(122,8,'','termunicip','Murindo','',0),(123,8,'','termunicip','Mutata','',0),(124,8,'','termunicip','Narino','',0),(125,8,'','termunicip','Nechi','',0),(126,8,'','termunicip','Necocli','',0),(127,8,'','termunicip','Olaya','',0),(128,8,'','termunicip','Peque','',0),(129,8,'','termunicip','Pueblorrico','',0),(130,8,'','termunicip','Puerto berrio','',0),(131,8,'','termunicip','Puerto nare','',0),(132,8,'','termunicip','Puerto triunfo','',0),(133,8,'','termunicip','Remedios','',0),(134,8,'','termunicip','Rionegro','',0),(135,8,'','termunicip','Sabanalarga','',0),(136,8,'','termunicip','Sabaneta','',0),(137,8,'','termunicip','Salgar','',0),(138,8,'','termunicip','San andres de cuerquia','',0),(139,8,'','termunicip','San carlos','',0),(140,8,'','termunicip','San francisco','',0),(141,8,'','termunicip','San jeronimo','',0),(142,8,'','termunicip','San jose de la montaña','',0),(143,8,'','termunicip','San juan de uraba','',0),(144,8,'','termunicip','San luis','',0),(145,8,'','termunicip','San pedro de los milagros','',0),(146,8,'','termunicip','San pedro de uraba','',0),(147,8,'','termunicip','San rafael','',0),(148,8,'','termunicip','San roque','',0),(149,8,'','termunicip','San vicente','',0),(150,8,'','termunicip','Santa barbara','',0),(151,8,'','termunicip','Santa rosa de osos','',0),(152,8,'','termunicip','Santo domingo','',0),(153,8,'','termunicip','Santuario','',0),(154,8,'','termunicip','Segovia','',0),(155,8,'','termunicip','Sonson','',0),(156,8,'','termunicip','Sopetran','',0),(157,8,'','termunicip','Tamesis','',0),(158,8,'','termunicip','Taraza','',0),(159,8,'','termunicip','Tarso','',0),(160,8,'','termunicip','Titiribi','',0),(161,8,'','termunicip','Toledo','',0),(162,8,'','termunicip','Turbo','',0),(163,8,'','termunicip','Uramita','',0),(164,8,'','termunicip','Urrao','',0),(165,8,'','termunicip','Valdivia','',0),(166,8,'','termunicip','Valparaiso','',0),(167,8,'','termunicip','Vegachi','',0),(168,8,'','termunicip','Venecia','',0),(169,8,'','termunicip','Vigia del fuerte','',0),(170,8,'','termunicip','Yali','',0),(171,8,'','termunicip','Yarumal','',0),(172,8,'','termunicip','Yolombo','',0),(173,8,'','termunicip','Yondo','',0),(174,8,'','termunicip','Zaragoza','',0),(175,9,'','termunicip','Arauca','',0),(176,9,'','termunicip','Arauquita','',0),(177,9,'','termunicip','Cravo norte','',0),(178,9,'','termunicip','Fortul','',0),(179,9,'','termunicip','Puerto rondon','',0),(180,9,'','termunicip','Saravena','',0),(181,9,'','termunicip','Tame','',0),(182,10,'','termunicip','Baranoa','',0),(183,10,'','termunicip','Barranquilla','',0),(184,10,'','termunicip','Campo de la cruz','',0),(185,10,'','termunicip','Candelaria','',0),(186,10,'','termunicip','Galapa','',0),(187,10,'','termunicip','Juan de acosta','',0),(188,10,'','termunicip','Luruaco','',0),(189,10,'','termunicip','Malambo','',0),(190,10,'','termunicip','Manati','',0),(191,10,'','termunicip','Palmar de varela','',0),(192,10,'','termunicip','Piojo','',0),(193,10,'','termunicip','Polo nuevo','',0),(194,10,'','termunicip','Ponedera','',0),(195,10,'','termunicip','Puerto colombia','',0),(196,10,'','termunicip','Repelon','',0),(197,10,'','termunicip','Sabanagrande','',0),(198,10,'','termunicip','Sabanalarga','',0),(199,10,'','termunicip','Santa lucia','',0),(200,10,'','termunicip','Santo tomas','',0),(201,10,'','termunicip','Soledad','',0),(202,10,'','termunicip','Suan','',0),(203,10,'','termunicip','Tubara','',0),(204,10,'','termunicip','Usiacuri','',0),(205,11,'','termunicip','Achi','',0),(206,11,'','termunicip','Altos del rosario','',0),(207,11,'','termunicip','Arenal','',0),(208,11,'','termunicip','Arjona','',0),(209,11,'','termunicip','Arroyohondo','',0),(210,11,'','termunicip','Barranco de loba','',0),(211,11,'','termunicip','Brazuelo de papayal','',0),(212,11,'','termunicip','Calamar','',0),(213,11,'','termunicip','Cantagallo','',0),(214,11,'','termunicip','Cartagena de indias','',0),(215,11,'','termunicip','Cicuco','',0),(216,11,'','termunicip','Clemencia','',0),(217,11,'','termunicip','Cordoba','',0),(218,11,'','termunicip','El carmen de bolivar','',0),(219,11,'','termunicip','El guamo','',0),(220,11,'','termunicip','El penion','',0),(221,11,'','termunicip','Hatillo de loba','',0),(222,11,'','termunicip','Magangue','',0),(223,11,'','termunicip','Mahates','',0),(224,11,'','termunicip','Margarita','',0),(225,11,'','termunicip','Maria la baja','',0),(226,11,'','termunicip','Montecristo','',0),(227,11,'','termunicip','Morales','',0),(228,11,'','termunicip','Morales','',0),(229,11,'','termunicip','Norosi','',0),(230,11,'','termunicip','Pinillos','',0),(231,11,'','termunicip','Regidor','',0),(232,11,'','termunicip','Rio viejo','',0),(233,11,'','termunicip','San cristobal','',0),(234,11,'','termunicip','San estanislao','',0),(235,11,'','termunicip','San fernando','',0),(236,11,'','termunicip','San jacinto','',0),(237,11,'','termunicip','San jacinto del cauca','',0),(238,11,'','termunicip','San juan de nepomuceno','',0),(239,11,'','termunicip','San martin de loba','',0),(240,11,'','termunicip','San pablo','',0),(241,11,'','termunicip','San pablo norte','',0),(242,11,'','termunicip','Santa catalina','',0),(243,11,'','termunicip','Santa cruz de mompox','',0),(244,11,'','termunicip','Santa rosa','',0),(245,11,'','termunicip','Santa rosa del sur','',0),(246,11,'','termunicip','Simiti','',0),(247,11,'','termunicip','Soplaviento','',0),(248,11,'','termunicip','Talaigua nuevo','',0),(249,11,'','termunicip','Tuquisio','',0),(250,11,'','termunicip','Turbaco','',0),(251,11,'','termunicip','Turbana','',0),(252,11,'','termunicip','Villanueva','',0),(253,11,'','termunicip','Zambrano','',0),(254,12,'','termunicip','Aquitania','',0),(255,12,'','termunicip','Arcabuco','',0),(256,12,'','termunicip','Belén','',0),(257,12,'','termunicip','Berbeo','',0),(258,12,'','termunicip','Betéitiva','',0),(259,12,'','termunicip','Boavita','',0),(260,12,'','termunicip','Boyacá','',0),(261,12,'','termunicip','Briceño','',0),(262,12,'','termunicip','Buenavista','',0),(263,12,'','termunicip','Busbanzá','',0),(264,12,'','termunicip','Caldas','',0),(265,12,'','termunicip','Campo hermoso','',0),(266,12,'','termunicip','Cerinza','',0),(267,12,'','termunicip','Chinavita','',0),(268,12,'','termunicip','Chiquinquirá','',0),(269,12,'','termunicip','Chíquiza','',0),(270,12,'','termunicip','Chiscas','',0),(271,12,'','termunicip','Chita','',0),(272,12,'','termunicip','Chitaraque','',0),(273,12,'','termunicip','Chivatá','',0),(274,12,'','termunicip','Ciénega','',0),(275,12,'','termunicip','Cómbita','',0),(276,12,'','termunicip','Coper','',0),(277,12,'','termunicip','Corrales','',0),(278,12,'','termunicip','Covarachía','',0),(279,12,'','termunicip','Cubara','',0),(280,12,'','termunicip','Cucaita','',0),(281,12,'','termunicip','Cuitiva','',0),(282,12,'','termunicip','Duitama','',0),(283,12,'','termunicip','El cocuy','',0),(284,12,'','termunicip','El espino','',0),(285,12,'','termunicip','Firavitoba','',0),(286,12,'','termunicip','Floresta','',0),(287,12,'','termunicip','Gachantivá','',0),(288,12,'','termunicip','Gámeza','',0),(289,12,'','termunicip','Garagoa','',0),(290,12,'','termunicip','Guacamayas','',0),(291,12,'','termunicip','Güicán','',0),(292,12,'','termunicip','Iza','',0),(293,12,'','termunicip','Jenesano','',0),(294,12,'','termunicip','Jericó','',0),(295,12,'','termunicip','La uvita','',0),(296,12,'','termunicip','La victoria','',0),(297,12,'','termunicip','Labranza grande','',0),(298,12,'','termunicip','Macanal','',0),(299,12,'','termunicip','Maripí','',0),(300,12,'','termunicip','Miraflores','',0),(301,12,'','termunicip','Mongua','',0),(302,12,'','termunicip','Monguí','',0),(303,12,'','termunicip','Moniquirá','',0),(304,12,'','termunicip','Motavita','',0),(305,12,'','termunicip','Muzo','',0),(306,12,'','termunicip','Nobsa','',0),(307,12,'','termunicip','Nuevo colón','',0),(308,12,'','termunicip','Oicatá','',0),(309,12,'','termunicip','Otanche','',0),(310,12,'','termunicip','Pachavita','',0),(311,12,'','termunicip','Páez','',0),(312,12,'','termunicip','Paipa','',0),(313,12,'','termunicip','Pajarito','',0),(314,12,'','termunicip','Panqueba','',0),(315,12,'','termunicip','Pauna','',0),(316,12,'','termunicip','Paya','',0),(317,12,'','termunicip','Paz de río','',0),(318,12,'','termunicip','Pesca','',0),(319,12,'','termunicip','Pisba','',0),(320,12,'','termunicip','Puerto boyaca','',0),(321,12,'','termunicip','Quípama','',0),(322,12,'','termunicip','Ramiriquí','',0),(323,12,'','termunicip','Ráquira','',0),(324,12,'','termunicip','Rondón','',0),(325,12,'','termunicip','Saboyá','',0),(326,12,'','termunicip','Sáchica','',0),(327,12,'','termunicip','Samacá','',0),(328,12,'','termunicip','San eduardo','',0),(329,12,'','termunicip','San josé de pare','',0),(330,12,'','termunicip','San luís de gaceno','',0),(331,12,'','termunicip','San mateo','',0),(332,12,'','termunicip','San miguel de sema','',0),(333,12,'','termunicip','San pablo de borbur','',0),(334,12,'','termunicip','Santa maría','',0),(335,12,'','termunicip','Santa rosa de viterbo','',0),(336,12,'','termunicip','Santa sofía','',0),(337,12,'','termunicip','Santana','',0),(338,12,'','termunicip','Sativanorte','',0),(339,12,'','termunicip','Sativasur','',0),(340,12,'','termunicip','Siachoque','',0),(341,12,'','termunicip','Soatá','',0),(342,12,'','termunicip','Socha','',0),(343,12,'','termunicip','Socotá','',0),(344,12,'','termunicip','Sogamoso','',0),(345,12,'','termunicip','Sora','',0),(346,12,'','termunicip','Soracá','',0),(347,12,'','termunicip','Sotaquirá','',0),(348,12,'','termunicip','Susacón','',0),(349,12,'','termunicip','Sutarmachán','',0),(350,12,'','termunicip','Tasco','',0),(351,12,'','termunicip','Tibaná','',0),(352,12,'','termunicip','Tibasosa','',0),(353,12,'','termunicip','Tinjacá','',0),(354,12,'','termunicip','Tipacoque','',0),(355,12,'','termunicip','Toca','',0),(356,12,'','termunicip','Togüí','',0),(357,12,'','termunicip','Tópaga','',0),(358,12,'','termunicip','Tota','',0),(359,12,'','termunicip','Tunja','',0),(360,12,'','termunicip','Tununguá','',0),(361,12,'','termunicip','Turmequé','',0),(362,12,'','termunicip','Tuta','',0),(363,12,'','termunicip','Tutazá','',0),(364,12,'','termunicip','Umbita','',0),(365,12,'','termunicip','Venta quemada','',0),(366,12,'','termunicip','Villa de leyva','',0),(367,12,'','termunicip','Viracachá','',0),(368,12,'','termunicip','Zetaquira','',0),(369,13,'','termunicip','Aguadas','',0),(370,13,'','termunicip','Anserma','',0),(371,13,'','termunicip','Aranzazu','',0),(372,13,'','termunicip','Belalcazar','',0),(373,13,'','termunicip','Chinchiná','',0),(374,13,'','termunicip','Filadelfia','',0),(375,13,'','termunicip','La dorada','',0),(376,13,'','termunicip','La merced','',0),(377,13,'','termunicip','Manizales','',0),(378,13,'','termunicip','Manzanares','',0),(379,13,'','termunicip','Marmato','',0),(380,13,'','termunicip','Marquetalia','',0),(381,13,'','termunicip','Marulanda','',0),(382,13,'','termunicip','Neira','',0),(383,13,'','termunicip','Norcasia','',0),(384,13,'','termunicip','Pacora','',0),(385,13,'','termunicip','Palestina','',0),(386,13,'','termunicip','Pensilvania','',0),(387,13,'','termunicip','Riosucio','',0),(388,13,'','termunicip','Risaralda','',0),(389,13,'','termunicip','Salamina','',0),(390,13,'','termunicip','Samana','',0),(391,13,'','termunicip','San jose','',0),(392,13,'','termunicip','Supía','',0),(393,13,'','termunicip','Victoria','',0),(394,13,'','termunicip','Villamaría','',0),(395,13,'','termunicip','Viterbo','',0),(396,14,'','termunicip','Albania','',0),(397,14,'','termunicip','Belén andaquies','',0),(398,14,'','termunicip','Cartagena del chaira','',0),(399,14,'','termunicip','Curillo','',0),(400,14,'','termunicip','El doncello','',0),(401,14,'','termunicip','El paujil','',0),(402,14,'','termunicip','Florencia','',0),(403,14,'','termunicip','La montañita','',0),(404,14,'','termunicip','Milán','',0),(405,14,'','termunicip','Morelia','',0),(406,14,'','termunicip','Puerto rico','',0),(407,14,'','termunicip','San  vicente del caguan','',0),(408,14,'','termunicip','San josé de fragua','',0),(409,14,'','termunicip','Solano','',0),(410,14,'','termunicip','Solita','',0),(411,14,'','termunicip','Valparaíso','',0),(412,15,'','termunicip','Aguazul','',0),(413,15,'','termunicip','Chameza','',0),(414,15,'','termunicip','Hato corozal','',0),(415,15,'','termunicip','La salina','',0),(416,15,'','termunicip','Maní','',0),(417,15,'','termunicip','Monterrey','',0),(418,15,'','termunicip','Nunchia','',0),(419,15,'','termunicip','Orocue','',0),(420,15,'','termunicip','Paz de ariporo','',0),(421,15,'','termunicip','Pore','',0),(422,15,'','termunicip','Recetor','',0),(423,15,'','termunicip','Sabana larga','',0),(424,15,'','termunicip','Sacama','',0),(425,15,'','termunicip','San luis de palenque','',0),(426,15,'','termunicip','Tamara','',0),(427,15,'','termunicip','Tauramena','',0),(428,15,'','termunicip','Trinidad','',0),(429,15,'','termunicip','Villanueva','',0),(430,15,'','termunicip','Yopal','',0),(431,16,'','termunicip','Almaguer','',0),(432,16,'','termunicip','Argelia','',0),(433,16,'','termunicip','Balboa','',0),(434,16,'','termunicip','Bolívar','',0),(435,16,'','termunicip','Buenos aires','',0),(436,16,'','termunicip','Cajibio','',0),(437,16,'','termunicip','Caldono','',0),(438,16,'','termunicip','Caloto','',0),(439,16,'','termunicip','Corinto','',0),(440,16,'','termunicip','El tambo','',0),(441,16,'','termunicip','Florencia','',0),(442,16,'','termunicip','Guapi','',0),(443,16,'','termunicip','Inza','',0),(444,16,'','termunicip','Jambaló','',0),(445,16,'','termunicip','La sierra','',0),(446,16,'','termunicip','La vega','',0),(447,16,'','termunicip','López','',0),(448,16,'','termunicip','Mercaderes','',0),(449,16,'','termunicip','Miranda','',0),(450,16,'','termunicip','Morales','',0),(451,16,'','termunicip','Padilla','',0),(452,16,'','termunicip','Páez','',0),(453,16,'','termunicip','Patia (el bordo)','',0),(454,16,'','termunicip','Piamonte','',0),(455,16,'','termunicip','Piendamo','',0),(456,16,'','termunicip','Popayán','',0),(457,16,'','termunicip','Puerto tejada','',0),(458,16,'','termunicip','Purace','',0),(459,16,'','termunicip','Rosas','',0),(460,16,'','termunicip','San sebastián','',0),(461,16,'','termunicip','Santa rosa','',0),(462,16,'','termunicip','Santander de quilichao','',0),(463,16,'','termunicip','Silvia','',0),(464,16,'','termunicip','Sotara','',0),(465,16,'','termunicip','Suárez','',0),(466,16,'','termunicip','Sucre','',0),(467,16,'','termunicip','Timbío','',0),(468,16,'','termunicip','Timbiquí','',0),(469,16,'','termunicip','Toribio','',0),(470,16,'','termunicip','Totoro','',0),(471,16,'','termunicip','Villa rica','',0),(472,17,'','termunicip','Aguachica','',0),(473,17,'','termunicip','Agustín codazzi','',0),(474,17,'','termunicip','Astrea','',0),(475,17,'','termunicip','Becerril','',0),(476,17,'','termunicip','Bosconia','',0),(477,17,'','termunicip','Chimichagua','',0),(478,17,'','termunicip','Chiriguaná','',0),(479,17,'','termunicip','Curumaní','',0),(480,17,'','termunicip','El copey','',0),(481,17,'','termunicip','El paso','',0),(482,17,'','termunicip','Gamarra','',0),(483,17,'','termunicip','González','',0),(484,17,'','termunicip','La gloria','',0),(485,17,'','termunicip','La jagua ibirico','',0),(486,17,'','termunicip','Manaure balcón del cesar','',0),(487,17,'','termunicip','Pailitas','',0),(488,17,'','termunicip','Pelaya','',0),(489,17,'','termunicip','Pueblo bello','',0),(490,17,'','termunicip','Río de oro','',0),(491,17,'','termunicip','Robles (la paz)','',0),(492,17,'','termunicip','San alberto','',0),(493,17,'','termunicip','San diego','',0),(494,17,'','termunicip','San martín','',0),(495,17,'','termunicip','Tamalameque','',0),(496,17,'','termunicip','Valledupar','',0),(497,18,'','termunicip','Acandi','',0),(498,18,'','termunicip','Alto baudo (pie de pato)','',0),(499,18,'','termunicip','Atrato','',0),(500,18,'','termunicip','Bagado','',0),(501,18,'','termunicip','Bahia solano (mutis)','',0),(502,18,'','termunicip','Bajo baudo (pizarro)','',0),(503,18,'','termunicip','Bojaya (bellavista)','',0),(504,18,'','termunicip','Canton de san pablo','',0),(505,18,'','termunicip','Carmen del darien','',0),(506,18,'','termunicip','Certegui','',0),(507,18,'','termunicip','Condoto','',0),(508,18,'','termunicip','El carmen','',0),(509,18,'','termunicip','Istmina','',0),(510,18,'','termunicip','Jurado','',0),(511,18,'','termunicip','Litoral del san juan','',0),(512,18,'','termunicip','Lloro','',0),(513,18,'','termunicip','Medio atrato','',0),(514,18,'','termunicip','Medio baudo (boca de pepe)','',0),(515,18,'','termunicip','Medio san juan','',0),(516,18,'','termunicip','Novita','',0),(517,18,'','termunicip','Nuqui','',0),(518,18,'','termunicip','Quibdo','',0),(519,18,'','termunicip','Rio iro','',0),(520,18,'','termunicip','Rio quito','',0),(521,18,'','termunicip','Riosucio','',0),(522,18,'','termunicip','San jose del palmar','',0),(523,18,'','termunicip','Sipi','',0),(524,18,'','termunicip','Tado','',0),(525,18,'','termunicip','Unguia','',0),(526,18,'','termunicip','Unión panamericana','',0),(527,19,'','termunicip','Ayapel','',0),(528,19,'','termunicip','Buenavista','',0),(529,19,'','termunicip','Canalete','',0),(530,19,'','termunicip','Cereté','',0),(531,19,'','termunicip','Chima','',0),(532,19,'','termunicip','Chinú','',0),(533,19,'','termunicip','Cienaga de oro','',0),(534,19,'','termunicip','Cotorra','',0),(535,19,'','termunicip','La apartada','',0),(536,19,'','termunicip','Lorica','',0),(537,19,'','termunicip','Los córdobas','',0),(538,19,'','termunicip','Momil','',0),(539,19,'','termunicip','Montelíbano','',0),(540,19,'','termunicip','Montería','',0),(541,19,'','termunicip','Moñitos','',0),(542,19,'','termunicip','Planeta rica','',0),(543,19,'','termunicip','Pueblo nuevo','',0),(544,19,'','termunicip','Puerto escondido','',0),(545,19,'','termunicip','Puerto libertador','',0),(546,19,'','termunicip','Purísima','',0),(547,19,'','termunicip','Sahagún','',0),(548,19,'','termunicip','San andrés sotavento','',0),(549,19,'','termunicip','San antero','',0),(550,19,'','termunicip','San bernardo viento','',0),(551,19,'','termunicip','San carlos','',0),(552,19,'','termunicip','San pelayo','',0),(553,19,'','termunicip','Tierralta','',0),(554,19,'','termunicip','Valencia','',0),(555,20,'','termunicip','Agua de dios','',0),(556,20,'','termunicip','Alban','',0),(557,20,'','termunicip','Anapoima','',0),(558,20,'','termunicip','Anolaima','',0),(559,20,'','termunicip','Arbelaez','',0),(560,20,'','termunicip','Beltrán','',0),(561,20,'','termunicip','Bituima','',0),(562,20,'','termunicip','Bogotá dc','',0),(563,20,'','termunicip','Bojacá','',0),(564,20,'','termunicip','Cabrera','',0),(565,20,'','termunicip','Cachipay','',0),(566,20,'','termunicip','Cajicá','',0),(567,20,'','termunicip','Caparrapí','',0),(568,20,'','termunicip','Caqueza','',0),(569,20,'','termunicip','Carmen de carupa','',0),(570,20,'','termunicip','Chaguaní','',0),(571,20,'','termunicip','Chia','',0),(572,20,'','termunicip','Chipaque','',0),(573,20,'','termunicip','Choachí','',0),(574,20,'','termunicip','Chocontá','',0),(575,20,'','termunicip','Cogua','',0),(576,20,'','termunicip','Cota','',0),(577,20,'','termunicip','Cucunubá','',0),(578,20,'','termunicip','El colegio','',0),(579,20,'','termunicip','El peñón','',0),(580,20,'','termunicip','El rosal1','',0),(581,20,'','termunicip','Facatativa','',0),(582,20,'','termunicip','Fómeque','',0),(583,20,'','termunicip','Fosca','',0),(584,20,'','termunicip','Funza','',0),(585,20,'','termunicip','Fúquene','',0),(586,20,'','termunicip','Fusagasuga','',0),(587,20,'','termunicip','Gachalá','',0),(588,20,'','termunicip','Gachancipá','',0),(589,20,'','termunicip','Gacheta','',0),(590,20,'','termunicip','Gama','',0),(591,20,'','termunicip','Girardot','',0),(592,20,'','termunicip','Granada2','',0),(593,20,'','termunicip','Guachetá','',0),(594,20,'','termunicip','Guaduas','',0),(595,20,'','termunicip','Guasca','',0),(596,20,'','termunicip','Guataquí','',0),(597,20,'','termunicip','Guatavita','',0),(598,20,'','termunicip','Guayabal de siquima','',0),(599,20,'','termunicip','Guayabetal','',0),(600,20,'','termunicip','Gutiérrez','',0),(601,20,'','termunicip','Jerusalén','',0),(602,20,'','termunicip','Junín','',0),(603,20,'','termunicip','La calera','',0),(604,20,'','termunicip','La mesa','',0),(605,20,'','termunicip','La palma','',0),(606,20,'','termunicip','La peña','',0),(607,20,'','termunicip','La vega','',0),(608,20,'','termunicip','Lenguazaque','',0),(609,20,'','termunicip','Machetá','',0),(610,20,'','termunicip','Madrid','',0),(611,20,'','termunicip','Manta','',0),(612,20,'','termunicip','Medina','',0),(613,20,'','termunicip','Mosquera','',0),(614,20,'','termunicip','Nariño','',0),(615,20,'','termunicip','Nemocón','',0),(616,20,'','termunicip','Nilo','',0),(617,20,'','termunicip','Nimaima','',0),(618,20,'','termunicip','Nocaima','',0),(619,20,'','termunicip','Ospina pérez','',0),(620,20,'','termunicip','Pacho','',0),(621,20,'','termunicip','Paime','',0),(622,20,'','termunicip','Pandi','',0),(623,20,'','termunicip','Paratebueno','',0),(624,20,'','termunicip','Pasca','',0),(625,20,'','termunicip','Puerto salgar','',0),(626,20,'','termunicip','Pulí','',0),(627,20,'','termunicip','Quebradanegra','',0),(628,20,'','termunicip','Quetame','',0),(629,20,'','termunicip','Quipile','',0),(630,20,'','termunicip','Rafael reyes','',0),(631,20,'','termunicip','Ricaurte','',0),(632,20,'','termunicip','San  antonio del  tequendama','',0),(633,20,'','termunicip','San bernardo','',0),(634,20,'','termunicip','San cayetano','',0),(635,20,'','termunicip','San francisco','',0),(636,20,'','termunicip','San juan de rioseco','',0),(637,20,'','termunicip','Sasaima','',0),(638,20,'','termunicip','Sesquilé','',0),(639,20,'','termunicip','Sibaté','',0),(640,20,'','termunicip','Silvania','',0),(641,20,'','termunicip','Simijaca','',0),(642,20,'','termunicip','Soacha','',0),(643,20,'','termunicip','Sopo','',0),(644,20,'','termunicip','Subachoque','',0),(645,20,'','termunicip','Suesca','',0),(646,20,'','termunicip','Supatá','',0),(647,20,'','termunicip','Susa','',0),(648,20,'','termunicip','Sutatausa','',0),(649,20,'','termunicip','Tabio','',0),(650,20,'','termunicip','Tausa','',0),(651,20,'','termunicip','Tena','',0),(652,20,'','termunicip','Tenjo','',0),(653,20,'','termunicip','Tibacuy','',0),(654,20,'','termunicip','Tibirita','',0),(655,20,'','termunicip','Tocaima','',0),(656,20,'','termunicip','Tocancipá','',0),(657,20,'','termunicip','Topaipí','',0),(658,20,'','termunicip','Ubalá','',0),(659,20,'','termunicip','Ubaque','',0),(660,20,'','termunicip','Ubaté','',0),(661,20,'','termunicip','Une','',0),(662,20,'','termunicip','Utica','',0),(663,20,'','termunicip','Vergara','',0),(664,20,'','termunicip','Viani','',0),(665,20,'','termunicip','Villa gomez','',0),(666,20,'','termunicip','Villa pinzón','',0),(667,20,'','termunicip','Villeta','',0),(668,20,'','termunicip','Viota','',0),(669,20,'','termunicip','Yacopí','',0),(670,20,'','termunicip','Zipacón','',0),(671,20,'','termunicip','Zipaquirá','',0),(672,21,'','termunicip','Barranco minas','',0),(673,21,'','termunicip','Cacahual','',0),(674,21,'','termunicip','Inírida','',0),(675,21,'','termunicip','La guadalupe','',0),(676,21,'','termunicip','Mapiripana','',0),(677,21,'','termunicip','Morichal','',0),(678,21,'','termunicip','Pana pana','',0),(679,21,'','termunicip','Puerto colombia','',0),(680,21,'','termunicip','San felipe','',0),(681,22,'','termunicip','Calamar','',0),(682,22,'','termunicip','El retorno','',0),(683,22,'','termunicip','Miraflorez','',0),(684,22,'','termunicip','San josé del guaviare','',0),(685,23,'','termunicip','Acevedo','',0),(686,23,'','termunicip','Agrado','',0),(687,23,'','termunicip','Aipe','',0),(688,23,'','termunicip','Algeciras','',0),(689,23,'','termunicip','Altamira','',0),(690,23,'','termunicip','Baraya','',0),(691,23,'','termunicip','Campo alegre','',0),(692,23,'','termunicip','Colombia','',0),(693,23,'','termunicip','Elias','',0),(694,23,'','termunicip','Garzón','',0),(695,23,'','termunicip','Gigante','',0),(696,23,'','termunicip','Guadalupe','',0),(697,23,'','termunicip','Hobo','',0),(698,23,'','termunicip','Iquira','',0),(699,23,'','termunicip','Isnos','',0),(700,23,'','termunicip','La argentina','',0),(701,23,'','termunicip','La plata','',0),(702,23,'','termunicip','Nataga','',0),(703,23,'','termunicip','Neiva','',0),(704,23,'','termunicip','Oporapa','',0),(705,23,'','termunicip','Paicol','',0),(706,23,'','termunicip','Palermo','',0),(707,23,'','termunicip','Palestina','',0),(708,23,'','termunicip','Pital','',0),(709,23,'','termunicip','Pitalito','',0),(710,23,'','termunicip','Rivera','',0),(711,23,'','termunicip','Salado blanco','',0),(712,23,'','termunicip','San agustín','',0),(713,23,'','termunicip','Santa maria','',0),(714,23,'','termunicip','Suaza','',0),(715,23,'','termunicip','Tarqui','',0),(716,23,'','termunicip','Tello','',0),(717,23,'','termunicip','Teruel','',0),(718,23,'','termunicip','Tesalia','',0),(719,23,'','termunicip','Timana','',0),(720,23,'','termunicip','Villavieja','',0),(721,23,'','termunicip','Yaguara','',0),(722,24,'','termunicip','Albania','',0),(723,24,'','termunicip','Barrancas','',0),(724,24,'','termunicip','Dibulla','',0),(725,24,'','termunicip','Distracción','',0),(726,24,'','termunicip','El molino','',0),(727,24,'','termunicip','Fonseca','',0),(728,24,'','termunicip','Hato nuevo','',0),(729,24,'','termunicip','La jagua del pilar','',0),(730,24,'','termunicip','Maicao','',0),(731,24,'','termunicip','Manaure','',0),(732,24,'','termunicip','Riohacha','',0),(733,24,'','termunicip','San juan del cesar','',0),(734,24,'','termunicip','Uribia','',0),(735,24,'','termunicip','Urumita','',0),(736,24,'','termunicip','Villanueva','',0),(737,25,'','termunicip','Algarrobo','',0),(738,25,'','termunicip','Aracataca','',0),(739,25,'','termunicip','Ariguani','',0),(740,25,'','termunicip','Cerro san antonio','',0),(741,25,'','termunicip','Chivolo','',0),(742,25,'','termunicip','Cienaga','',0),(743,25,'','termunicip','Concordia','',0),(744,25,'','termunicip','El banco','',0),(745,25,'','termunicip','El piñon','',0),(746,25,'','termunicip','El reten','',0),(747,25,'','termunicip','Fundacion','',0),(748,25,'','termunicip','Guamal','',0),(749,25,'','termunicip','Nueva granada','',0),(750,25,'','termunicip','Pedraza','',0),(751,25,'','termunicip','Pijiño del carmen','',0),(752,25,'','termunicip','Pivijay','',0),(753,25,'','termunicip','Plato','',0),(754,25,'','termunicip','Pueblo viejo','',0),(755,25,'','termunicip','Remolino','',0),(756,25,'','termunicip','Sabanas de san angel','',0),(757,25,'','termunicip','Salamina','',0),(758,25,'','termunicip','San sebastian de buenavista','',0),(759,25,'','termunicip','San zenon','',0),(760,25,'','termunicip','Santa ana','',0),(761,25,'','termunicip','Santa barbara de pinto','',0),(762,25,'','termunicip','Santa marta','',0),(763,25,'','termunicip','Sitionuevo','',0),(764,25,'','termunicip','Tenerife','',0),(765,25,'','termunicip','Zapayan','',0),(766,25,'','termunicip','Zona bananera','',0),(767,26,'','termunicip','Acacias','',0),(768,26,'','termunicip','Barranca de upia','',0),(769,26,'','termunicip','Cabuyaro','',0),(770,26,'','termunicip','Castilla la nueva','',0),(771,26,'','termunicip','Cubarral','',0),(772,26,'','termunicip','Cumaral','',0),(773,26,'','termunicip','El calvario','',0),(774,26,'','termunicip','El castillo','',0),(775,26,'','termunicip','El dorado','',0),(776,26,'','termunicip','Fuente de oro','',0),(777,26,'','termunicip','Granada','',0),(778,26,'','termunicip','Guamal','',0),(779,26,'','termunicip','La macarena','',0),(780,26,'','termunicip','La uribe','',0),(781,26,'','termunicip','Lejanías','',0),(782,26,'','termunicip','Mapiripán','',0),(783,26,'','termunicip','Mesetas','',0),(784,26,'','termunicip','Puerto concordia','',0),(785,26,'','termunicip','Puerto gaitán','',0),(786,26,'','termunicip','Puerto lleras','',0),(787,26,'','termunicip','Puerto lópez','',0),(788,26,'','termunicip','Puerto rico','',0),(789,26,'','termunicip','Restrepo','',0),(790,26,'','termunicip','San  juan de arama','',0),(791,26,'','termunicip','San carlos guaroa','',0),(792,26,'','termunicip','San juanito','',0),(793,26,'','termunicip','San martín','',0),(794,26,'','termunicip','Villavicencio','',0),(795,26,'','termunicip','Vista hermosa','',0),(796,27,'','termunicip','Alban','',0),(797,27,'','termunicip','Aldaña','',0),(798,27,'','termunicip','Ancuya','',0),(799,27,'','termunicip','Arboleda','',0),(800,27,'','termunicip','Barbacoas','',0),(801,27,'','termunicip','Belen','',0),(802,27,'','termunicip','Buesaco','',0),(803,27,'','termunicip','Chachagui','',0),(804,27,'','termunicip','Colon (genova)','',0),(805,27,'','termunicip','Consaca','',0),(806,27,'','termunicip','Contadero','',0),(807,27,'','termunicip','Cordoba','',0),(808,27,'','termunicip','Cuaspud','',0),(809,27,'','termunicip','Cumbal','',0),(810,27,'','termunicip','Cumbitara','',0),(811,27,'','termunicip','El charco','',0),(812,27,'','termunicip','El peñol','',0),(813,27,'','termunicip','El rosario','',0),(814,27,'','termunicip','El tablón','',0),(815,27,'','termunicip','El tambo','',0),(816,27,'','termunicip','Funes','',0),(817,27,'','termunicip','Guachucal','',0),(818,27,'','termunicip','Guaitarilla','',0),(819,27,'','termunicip','Gualmatan','',0),(820,27,'','termunicip','Iles','',0),(821,27,'','termunicip','Imues','',0),(822,27,'','termunicip','Ipiales','',0),(823,27,'','termunicip','La cruz','',0),(824,27,'','termunicip','La florida','',0),(825,27,'','termunicip','La llanada','',0),(826,27,'','termunicip','La tola','',0),(827,27,'','termunicip','La union','',0),(828,27,'','termunicip','Leiva','',0),(829,27,'','termunicip','Linares','',0),(830,27,'','termunicip','Los andes','',0),(831,27,'','termunicip','Magui','',0),(832,27,'','termunicip','Mallama','',0),(833,27,'','termunicip','Mosqueza','',0),(834,27,'','termunicip','Nariño','',0),(835,27,'','termunicip','Olaya herrera','',0),(836,27,'','termunicip','Ospina','',0),(837,27,'','termunicip','Pasto','',0),(838,27,'','termunicip','Pizarro','',0),(839,27,'','termunicip','Policarpa','',0),(840,27,'','termunicip','Potosi','',0),(841,27,'','termunicip','Providencia','',0),(842,27,'','termunicip','Puerres','',0),(843,27,'','termunicip','Pupiales','',0),(844,27,'','termunicip','Ricaurte','',0),(845,27,'','termunicip','Roberto payan','',0),(846,27,'','termunicip','Samaniego','',0),(847,27,'','termunicip','San bernardo','',0),(848,27,'','termunicip','San lorenzo','',0),(849,27,'','termunicip','San pablo','',0),(850,27,'','termunicip','San pedro de cartago','',0),(851,27,'','termunicip','Sandona','',0),(852,27,'','termunicip','Santa barbara','',0),(853,27,'','termunicip','Santacruz','',0),(854,27,'','termunicip','Sapuyes','',0),(855,27,'','termunicip','Taminango','',0),(856,27,'','termunicip','Tangua','',0),(857,27,'','termunicip','Tumaco','',0),(858,27,'','termunicip','Tuquerres','',0),(859,27,'','termunicip','Yacuanquer','',0),(860,28,'','termunicip','Abrego','',0),(861,28,'','termunicip','Arboledas','',0),(862,28,'','termunicip','Bochalema','',0),(863,28,'','termunicip','Bucarasica','',0),(864,28,'','termunicip','Cáchira','',0),(865,28,'','termunicip','Cácota','',0),(866,28,'','termunicip','Chinácota','',0),(867,28,'','termunicip','Chitagá','',0),(868,28,'','termunicip','Convención','',0),(869,28,'','termunicip','Cúcuta','',0),(870,28,'','termunicip','Cucutilla','',0),(871,28,'','termunicip','Durania','',0),(872,28,'','termunicip','El carmen','',0),(873,28,'','termunicip','El tarra','',0),(874,28,'','termunicip','El zulia','',0),(875,28,'','termunicip','Gramalote','',0),(876,28,'','termunicip','Hacari','',0),(877,28,'','termunicip','Herrán','',0),(878,28,'','termunicip','La esperanza','',0),(879,28,'','termunicip','La playa','',0),(880,28,'','termunicip','Labateca','',0),(881,28,'','termunicip','Los patios','',0),(882,28,'','termunicip','Lourdes','',0),(883,28,'','termunicip','Mutiscua','',0),(884,28,'','termunicip','Ocaña','',0),(885,28,'','termunicip','Pamplona','',0),(886,28,'','termunicip','Pamplonita','',0),(887,28,'','termunicip','Puerto santander','',0),(888,28,'','termunicip','Ragonvalia','',0),(889,28,'','termunicip','Salazar','',0),(890,28,'','termunicip','San calixto','',0),(891,28,'','termunicip','San cayetano','',0),(892,28,'','termunicip','Santiago','',0),(893,28,'','termunicip','Sardinata','',0),(894,28,'','termunicip','Silos','',0),(895,28,'','termunicip','Teorama','',0),(896,28,'','termunicip','Tibú','',0),(897,28,'','termunicip','Toledo','',0),(898,28,'','termunicip','Villa caro','',0),(899,28,'','termunicip','Villa del rosario','',0),(900,29,'','termunicip','Colón','',0),(901,29,'','termunicip','Mocoa','',0),(902,29,'','termunicip','Orito','',0),(903,29,'','termunicip','Puerto asís','',0),(904,29,'','termunicip','Puerto caycedo','',0),(905,29,'','termunicip','Puerto guzmán','',0),(906,29,'','termunicip','Puerto leguízamo','',0),(907,29,'','termunicip','San francisco','',0),(908,29,'','termunicip','San miguel','',0),(909,29,'','termunicip','Santiago','',0),(910,29,'','termunicip','Sibundoy','',0),(911,29,'','termunicip','Valle del guamuez','',0),(912,29,'','termunicip','Villagarzón','',0),(913,30,'','termunicip','Armenia','',0),(914,30,'','termunicip','Buenavista','',0),(915,30,'','termunicip','Calarcá','',0),(916,30,'','termunicip','Circasia','',0),(917,30,'','termunicip','Córdoba','',0),(918,30,'','termunicip','Filandia','',0),(919,30,'','termunicip','Génova','',0),(920,30,'','termunicip','La tebaida','',0),(921,30,'','termunicip','Montenegro','',0),(922,30,'','termunicip','Pijao','',0),(923,30,'','termunicip','Quimbaya','',0),(924,30,'','termunicip','Salento','',0),(925,31,'','termunicip','Apia','',0),(926,31,'','termunicip','Balboa','',0),(927,31,'','termunicip','Belén de umbría','',0),(928,31,'','termunicip','Dos quebradas','',0),(929,31,'','termunicip','Guatica','',0),(930,31,'','termunicip','La celia','',0),(931,31,'','termunicip','La virginia','',0),(932,31,'','termunicip','Marsella','',0),(933,31,'','termunicip','Mistrato','',0),(934,31,'','termunicip','Pereira','',0),(935,31,'','termunicip','Pueblo rico','',0),(936,31,'','termunicip','Quinchía','',0),(937,31,'','termunicip','Santa rosa de cabal','',0),(938,31,'','termunicip','Santuario','',0),(939,32,'','termunicip','Providencia','',0),(940,32,'','termunicip','San andres','',0),(941,32,'','termunicip','Santa catalina','',0),(942,33,'','termunicip','Aguada','',0),(943,33,'','termunicip','Albania','',0),(944,33,'','termunicip','Aratoca','',0),(945,33,'','termunicip','Barbosa','',0),(946,33,'','termunicip','Barichara','',0),(947,33,'','termunicip','Barrancabermeja','',0),(948,33,'','termunicip','Betulia','',0),(949,33,'','termunicip','Bolívar','',0),(950,33,'','termunicip','Bucaramanga','',0),(951,33,'','termunicip','Cabrera','',0),(952,33,'','termunicip','California','',0),(953,33,'','termunicip','Capitanejo','',0),(954,33,'','termunicip','Carcasi','',0),(955,33,'','termunicip','Cepita','',0),(956,33,'','termunicip','Cerrito','',0),(957,33,'','termunicip','Charalá','',0),(958,33,'','termunicip','Charta','',0),(959,33,'','termunicip','Chima','',0),(960,33,'','termunicip','Chipatá','',0),(961,33,'','termunicip','Cimitarra','',0),(962,33,'','termunicip','Concepción','',0),(963,33,'','termunicip','Confines','',0),(964,33,'','termunicip','Contratación','',0),(965,33,'','termunicip','Coromoro','',0),(966,33,'','termunicip','Curití','',0),(967,33,'','termunicip','El carmen','',0),(968,33,'','termunicip','El guacamayo','',0),(969,33,'','termunicip','El peñón','',0),(970,33,'','termunicip','El playón','',0),(971,33,'','termunicip','Encino','',0),(972,33,'','termunicip','Enciso','',0),(973,33,'','termunicip','Florián','',0),(974,33,'','termunicip','Floridablanca','',0),(975,33,'','termunicip','Galán','',0),(976,33,'','termunicip','Gambita','',0),(977,33,'','termunicip','Girón','',0),(978,33,'','termunicip','Guaca','',0),(979,33,'','termunicip','Guadalupe','',0),(980,33,'','termunicip','Guapota','',0),(981,33,'','termunicip','Guavatá','',0),(982,33,'','termunicip','Guepsa','',0),(983,33,'','termunicip','Hato','',0),(984,33,'','termunicip','Jesús maria','',0),(985,33,'','termunicip','Jordán','',0),(986,33,'','termunicip','La belleza','',0),(987,33,'','termunicip','La paz','',0),(988,33,'','termunicip','Landazuri','',0),(989,33,'','termunicip','Lebrija','',0),(990,33,'','termunicip','Los santos','',0),(991,33,'','termunicip','Macaravita','',0),(992,33,'','termunicip','Málaga','',0),(993,33,'','termunicip','Matanza','',0),(994,33,'','termunicip','Mogotes','',0),(995,33,'','termunicip','Molagavita','',0),(996,33,'','termunicip','Ocamonte','',0),(997,33,'','termunicip','Oiba','',0),(998,33,'','termunicip','Onzaga','',0),(999,33,'','termunicip','Palmar','',0),(1000,33,'','termunicip','Palmas del socorro','',0),(1001,33,'','termunicip','Páramo','',0),(1002,33,'','termunicip','Piedecuesta','',0),(1003,33,'','termunicip','Pinchote','',0),(1004,33,'','termunicip','Puente nacional','',0),(1005,33,'','termunicip','Puerto parra','',0),(1006,33,'','termunicip','Puerto wilches','',0),(1007,33,'','termunicip','Rionegro','',0),(1008,33,'','termunicip','Sabana de torres','',0),(1009,33,'','termunicip','San andrés','',0),(1010,33,'','termunicip','San benito','',0),(1011,33,'','termunicip','San gil','',0),(1012,33,'','termunicip','San joaquín','',0),(1013,33,'','termunicip','San josé de miranda','',0),(1014,33,'','termunicip','San miguel','',0),(1015,33,'','termunicip','San vicente de chucurí','',0),(1016,33,'','termunicip','Santa bárbara','',0),(1017,33,'','termunicip','Santa helena','',0),(1018,33,'','termunicip','Simacota','',0),(1019,33,'','termunicip','Socorro','',0),(1020,33,'','termunicip','Suaita','',0),(1021,33,'','termunicip','Sucre','',0),(1022,33,'','termunicip','Surata','',0),(1023,33,'','termunicip','Tona','',0),(1024,33,'','termunicip','Valle san josé','',0),(1025,33,'','termunicip','Vélez','',0),(1026,33,'','termunicip','Vetas','',0),(1027,33,'','termunicip','Villanueva','',0),(1028,33,'','termunicip','Zapatoca','',0),(1029,34,'','termunicip','Buenavista','',0),(1030,34,'','termunicip','Caimito','',0),(1031,34,'','termunicip','Chalán','',0),(1032,34,'','termunicip','Coloso','',0),(1033,34,'','termunicip','Corozal','',0),(1034,34,'','termunicip','El roble','',0),(1035,34,'','termunicip','Galeras','',0),(1036,34,'','termunicip','Guaranda','',0),(1037,34,'','termunicip','La unión','',0),(1038,34,'','termunicip','Los palmitos','',0),(1039,34,'','termunicip','Majagual','',0),(1040,34,'','termunicip','Morroa','',0),(1041,34,'','termunicip','Ovejas','',0),(1042,34,'','termunicip','Palmito','',0),(1043,34,'','termunicip','Sampues','',0),(1044,34,'','termunicip','San benito abad','',0),(1045,34,'','termunicip','San juan de betulia','',0),(1046,34,'','termunicip','San marcos','',0),(1047,34,'','termunicip','San onofre','',0),(1048,34,'','termunicip','San pedro','',0),(1049,34,'','termunicip','Sincé','',0),(1050,34,'','termunicip','Sincelejo','',0),(1051,34,'','termunicip','Sucre','',0),(1052,34,'','termunicip','Tolú','',0),(1053,34,'','termunicip','Toluviejo','',0),(1054,35,'','termunicip','Alpujarra','',0),(1055,35,'','termunicip','Alvarado','',0),(1056,35,'','termunicip','Ambalema','',0),(1057,35,'','termunicip','Anzoategui','',0),(1058,35,'','termunicip','Armero (guayabal)','',0),(1059,35,'','termunicip','Ataco','',0),(1060,35,'','termunicip','Cajamarca','',0),(1061,35,'','termunicip','Carmen de apicalá','',0),(1062,35,'','termunicip','Casabianca','',0),(1063,35,'','termunicip','Chaparral','',0),(1064,35,'','termunicip','Coello','',0),(1065,35,'','termunicip','Coyaima','',0),(1066,35,'','termunicip','Cunday','',0),(1067,35,'','termunicip','Dolores','',0),(1068,35,'','termunicip','Espinal','',0),(1069,35,'','termunicip','Falán','',0),(1070,35,'','termunicip','Flandes','',0),(1071,35,'','termunicip','Fresno','',0),(1072,35,'','termunicip','Guamo','',0),(1073,35,'','termunicip','Herveo','',0),(1074,35,'','termunicip','Honda','',0),(1075,35,'','termunicip','Ibagué','',0),(1076,35,'','termunicip','Icononzo','',0),(1077,35,'','termunicip','Lérida','',0),(1078,35,'','termunicip','Líbano','',0),(1079,35,'','termunicip','Mariquita','',0),(1080,35,'','termunicip','Melgar','',0),(1081,35,'','termunicip','Murillo','',0),(1082,35,'','termunicip','Natagaima','',0),(1083,35,'','termunicip','Ortega','',0),(1084,35,'','termunicip','Palocabildo','',0),(1085,35,'','termunicip','Piedras planadas','',0),(1086,35,'','termunicip','Prado','',0),(1087,35,'','termunicip','Purificación','',0),(1088,35,'','termunicip','Rioblanco','',0),(1089,35,'','termunicip','Roncesvalles','',0),(1090,35,'','termunicip','Rovira','',0),(1091,35,'','termunicip','Saldaña','',0),(1092,35,'','termunicip','San antonio','',0),(1093,35,'','termunicip','San luis','',0),(1094,35,'','termunicip','Santa isabel','',0),(1095,35,'','termunicip','Suárez','',0),(1096,35,'','termunicip','Valle de san juan','',0),(1097,35,'','termunicip','Venadillo','',0),(1098,35,'','termunicip','Villahermosa','',0),(1099,35,'','termunicip','Villarrica','',0),(1100,36,'','termunicip','Alcalá','',0),(1101,36,'','termunicip','Andalucía','',0),(1102,36,'','termunicip','Anserma nuevo','',0),(1103,36,'','termunicip','Argelia','',0),(1104,36,'','termunicip','Bolívar','',0),(1105,36,'','termunicip','Buenaventura','',0),(1106,36,'','termunicip','Buga','',0),(1107,36,'','termunicip','Bugalagrande','',0),(1108,36,'','termunicip','Caicedonia','',0),(1109,36,'','termunicip','Cali','',0),(1110,36,'','termunicip','Calima (darien)','',0),(1111,36,'','termunicip','Candelaria','',0),(1112,36,'','termunicip','Cartago','',0),(1113,36,'','termunicip','Dagua','',0),(1114,36,'','termunicip','El aguila','',0),(1115,36,'','termunicip','El cairo','',0),(1116,36,'','termunicip','El cerrito','',0),(1117,36,'','termunicip','El dovio','',0),(1118,36,'','termunicip','Florida','',0),(1119,36,'','termunicip','Ginebra guacari','',0),(1120,36,'','termunicip','Jamundí','',0),(1121,36,'','termunicip','La cumbre','',0),(1122,36,'','termunicip','La unión','',0),(1123,36,'','termunicip','La victoria','',0),(1124,36,'','termunicip','Obando','',0),(1125,36,'','termunicip','Palmira','',0),(1126,36,'','termunicip','Pradera','',0),(1127,36,'','termunicip','Restrepo','',0),(1128,36,'','termunicip','Rio frío','',0),(1129,36,'','termunicip','Roldanillo','',0),(1130,36,'','termunicip','San pedro','',0),(1131,36,'','termunicip','Sevilla','',0),(1132,36,'','termunicip','Toro','',0),(1133,36,'','termunicip','Trujillo','',0),(1134,36,'','termunicip','Tulúa','',0),(1135,36,'','termunicip','Ulloa','',0),(1136,36,'','termunicip','Versalles','',0),(1137,36,'','termunicip','Vijes','',0),(1138,36,'','termunicip','Yotoco','',0),(1139,36,'','termunicip','Yumbo','',0),(1140,36,'','termunicip','Zarzal','',0),(1141,37,'','termunicip','Carurú','',0),(1142,37,'','termunicip','Mitú','',0),(1143,37,'','termunicip','Pacoa','',0),(1144,37,'','termunicip','Papunaua','',0),(1145,37,'','termunicip','Taraira','',0),(1146,37,'','termunicip','Yavaraté','',0),(1147,38,'','termunicip','Cumaribo','',0),(1148,38,'','termunicip','La primavera','',0),(1149,38,'','termunicip','Puerto carreño','',0),(1150,38,'','termunicip','Santa rosalia','',0);
...
insert  into `vencimientos`(`id`,`decripcion`,`eliminado`,`fecha_inicio`,`fecha_vencimiento`,`id_estado_vencimiento`,`id_tipo_cobertura`,`id_tipo_vencimiento`,`observaciones`,`pedido_id`,`serial`,`encvencimiento_id`) values (2,'ok',1,'25-03-2014','26-06-2014','vencubiert','ventipoc01','vensofibm',NULL,3,NULL,1);

/* Procedure structure for procedure `asignaOpeRol` */

/*!50003 DROP PROCEDURE IF EXISTS  `asignaOpeRol` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `asignaOpeRol`(IN _opcion INT, IN _rol INT)
BEGIN
	INSERT INTO `rol_opcion_operacion`(estado_rol_opcion_operacion, opcion_id, operacion_id, rol_id)
	VALUES ('A', _opcion, 1, _rol),
	('A', _opcion, 2, _rol),
	('A', _opcion, 3, _rol),
	('A', _opcion, 4, _rol),
	('A', _opcion, 5, _rol),
